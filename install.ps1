...
#   4. tar.exe -xzf 到 %USERPROFILE%\.openharness-sql\versions\<ver>\
#   5. 用 directory junction 原子切 current（不需要 admin）
#   6. 写 shim %USERPROFILE%\.openharness-sql\bin\ohsql.cmd
...
@echo off
node "%USERPROFILE%\.openharness-sql\current\dist\cli.js" %*
'@
